...
public class KhoanThuView extends RecyclerView.Adapter<KhoanThuView.ViewHolder> {
    ...
    public KhoanThuView(Context context, ArrayList<GiaoDich> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.imgXoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Bạn muốn xóa khoản thu?")
                        .setCancelable(false)
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mota = dialog.findViewById(R.id.ten);
